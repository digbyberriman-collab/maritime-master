...
Lovable applied phases 1–4 to the live project on 17 Sep 2026 and recorded them as copies under its own timestamps (`20260917175040`, `175431`, `180124`, `180528`, `180937`). Those copies are the originals plus table grants; they are idempotent alongside the phase files. The review-fixes migration is numbered `190000` so it sorts after them: it replaces RPC bodies the copies re-create, and must run last.
