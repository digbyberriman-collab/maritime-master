...
import type { AppRole, UserRole, PermissionContext } from '@/lib/permissions/types';
import { PERMISSION_MATRIX, SCOPE_MATRIX, roleHasPermission } from '@/lib/permissions/rbacMatrix';
import { AUDIT_MODE_RULES, isModuleAllowed, isActionAllowed } from '@/lib/permissions/auditModeRules';
