...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      candidates: {
        Row: {
          ...
          salary_expectation_minor: number | null
          source: string
          status: string
          updated_at: string
          updated_by: string | null
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "candidates_referred_by_profile_id_fkey"
      ...
      crew_change_dates: {
        Row: {
          ...
          source: Database["public"]["Enums"]["crew_change_source"]
          updated_at: string
          vessel_id: string
        }
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: "crew_change_dates_vessel_id_fkey"
            columns: ["vessel_id"]
            isOneToOne: false
            referencedRelation: "vessels"
            referencedColumns: ["id"]
      ...
      crew_objective_updates: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            isOneToOne: false
            referencedRelation: "crew_objectives"
            referencedColumns: ["id"]
          },
        ]
      }
      crew_objectives: {
        ...
        Relationships: [
          {
            foreignKeyName: "crew_objectives_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "crew_objectives_review_id_fkey"
            columns: ["review_id"]
            isOneToOne: false
      ...
      crew_work_authorisations: {
        ...
        Relationships: [
          {
            foreignKeyName: "crew_work_authorisations_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      disciplinary_records: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "disciplinary_records_issued_by_profile_id_fkey"
      ...
      incident_involved_persons: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "incident_involved_persons_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      interviews: {
        Row: {
          ...
          format: string
          id: string
          interviewer_profile_ids: string[]
          location: string | null
          outcome: string | null
          scheduled_at: string
          scorecard: Json
      ...
      itinerary_comments: {
        ...
        Relationships: [
          {
            foreignKeyName: "itinerary_comments_entry_id_fkey"
            columns: ["entry_id"]
            isOneToOne: false
      ...
      itinerary_entries: {
        ...
        Relationships: [
          {
            foreignKeyName: "itinerary_entries_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "itinerary_entries_port_id_fkey"
            columns: ["port_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "itinerary_entries_trip_type_id_fkey"
      ...
      itinerary_entry_vessels: {
        ...
        Relationships: [
          {
            foreignKeyName: "itinerary_entry_vessels_entry_id_fkey"
            columns: ["entry_id"]
            isOneToOne: false
            referencedRelation: "itinerary_entries"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "itinerary_entry_vessels_vessel_id_fkey"
            columns: ["vessel_id"]
            isOneToOne: false
            referencedRelation: "vessels"
            referencedColumns: ["id"]
      ...
      onboarding_records: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "onboarding_records_template_id_fkey"
            columns: ["template_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "onboarding_records_vessel_id_fkey"
            columns: ["vessel_id"]
            isOneToOne: false
            referencedRelation: "vessels"
            referencedColumns: ["id"]
      ...
      ports: {
        Row: {
          ...
          created_at: string
          created_by: string | null
          default_agent_contact: string | null
          default_agent_name: string | null
          id: string
          is_custom: boolean
          isps_compliant: boolean
          latitude: number | null
          longitude: number | null
          max_loa_metres: number | null
          name: string
          notes: string | null
          timezone: string | null
        }
      ...
      trip_suggestions: {
        ...
        Relationships: [
          {
            foreignKeyName: "trip_suggestions_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      trip_types: {
        ...
        Relationships: [
          {
            foreignKeyName: "trip_types_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      vacancies: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "vacancies_pay_grade_id_fkey"
            columns: ["pay_grade_id"]
            isOneToOne: false
            referencedRelation: "pay_grades"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      hw_settings_for: {
        Args: { p_company_id: string }
        Returns: Database["public"]["Tables"]["hw_settings"]["Row"]
      }
      med_fitness_can_view: {
    ...
    Enums: {
      ...
      audit_action_type:
        ...
        | "audit_mode_enabled"
        | "audit_mode_disabled"
      crew_change_source: "auto_generated" | "manual_override"
      diving_level:
        | "none"
        | "beginner"
        | "intermediate"
