...
const yardRefit: NavChild[] = [
  G('Overview', refitBase, [
    L('Dashboard', refitOverview, { icon: LayoutGrid }),
    L('Approvals Centre', refitOverview),
    L('Notifications', refitOverview),
    L('Search', refitOverview),
  ], { icon: LayoutGrid, slug: 'overview' }),
  G('Workflow', refitBase, [
    L('Change Orders', refitWorkflow),
    L('Crew Requests', refitWorkflow),
    L('Snags & Warranty', refitWorkflow),
    L('Works Orders', refitWorkflow),
    L('Meetings', refitWorkflow),
    L('Risk Register', refitWorkflow),
  ], { icon: Network, slug: 'workflow' }),
  G('Project', refitBase, [
    L('Schedule', refitProject),
    L('Logistics', refitProject),
    L('Inventory & Equipment', refitProject),
    L('Contractors & Suppliers', refitProject),
  ], { icon: ClipboardList, slug: 'project' }),
  G('Documents', refitBase, [
    L('Drawings & Plans', refitDocs),
    L('Document Control', refitDocs),
    L('Files', refitDocs),
  ], { icon: FileText, slug: 'documents' }),
  G('Finance', refitBase, [
    L('Budget', refitFinance),
    L('Purchase Orders', refitFinance),
    L('Invoices', refitFinance),
  ], { icon: Banknote, slug: 'finance' }),
  G('Compliance', refitBase, [
    L('Compliance', refitCompliance),
    L('Crew & Certification', refitCompliance),
    L('Audit Log', refitCompliance),
    L('Reporting', refitCompliance),
  ...
  G('Account & Admin', refitBase, [
    L('Access Profile', refitAccount),
    L('Communications', refitAccount),
    L('Diagnostics', refitAccount),
    L('Access Check', refitAccount),
    L('Admin & Settings', refitAccount),
    L('Import & API', refitAccount),
    L('Login Diagnostics', refitAccount),
