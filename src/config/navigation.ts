...
export const NAVIGATION_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    permissions: ['all'],
    children: [
      { id: 'checklists-forms', label: 'Checklists & Forms', path: '/ism/checklists', icon: CheckSquare },
      ...
      { id: 'risk-assessments', label: 'Risk Assessments', path: '/ism/risk-assessments', icon: AlertTriangle },
