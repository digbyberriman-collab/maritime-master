...
import { useRiskAssessmentTemplates, useUpdateRiskAssessmentTemplate, type RiskAssessmentTemplate } from '@/hooks/useRiskAssessments';
import { TASK_CATEGORIES, COMMON_HAZARDS } from '@/lib/riskAssessmentConstants';
