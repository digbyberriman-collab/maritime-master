...
import { getVisibleNavItems, canAccessSection, SETTINGS_NAV_ITEMS } from '@/shared/utils/settingsPermissions';
...
import SettingsMobileNav from '@/modules/settings/components/SettingsMobileNav';
import {
  ProfileSection,
  SecuritySection,
