  ...
  return (
    <DashboardLayout>
      <div className="space-y-6 animate-fade-in">
        <PageHeader
          title="Policies"
          description="Company policies and guidelines with acknowledgment tracking"
          actions={
            <Button className="gap-2" onClick={() => toast.info('Create policy feature coming soon')}>
        ...
        <Card className="shadow-card">
          <CardHeader>
            <CardTitle className="text-base">Policies ({filteredPolicies.length})</CardTitle>
            <CardDescription>
