...
import { Drill, useDrillDetails } from '@/modules/drills/hooks/useDrills';
import { DRILL_STATUSES, DEFICIENCY_SEVERITIES, EQUIPMENT_STATUSES, getDrillTypeColor } from '@/modules/drills/constants';
