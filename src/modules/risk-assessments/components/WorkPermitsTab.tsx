...
import { useWorkPermits, useDeleteWorkPermit, useUpdateWorkPermit, type WorkPermit } from '@/modules/risk-assessments/hooks/useRiskAssessments';
import { PERMIT_STATUS_OPTIONS, PERMIT_TYPE_OPTIONS } from '@/modules/risk-assessments/constants';
