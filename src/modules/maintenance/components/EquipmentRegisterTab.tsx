...
import { useMaintenance, EquipmentCategory, Equipment } from '@/modules/maintenance/hooks/useMaintenance';
import { getCriticalityConfig, getEquipmentStatusConfig } from '@/modules/maintenance/constants';
import { 
  Search, 
  Plus, 
  ChevronRight, 
