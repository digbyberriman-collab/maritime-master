...
import { getTrainingStatusColor, getCategoryColor, daysUntilExpiry, COURSE_CATEGORIES } from '@/modules/training/constants';
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        ...
        <Card>
          <CardContent className="pt-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-success">{complianceStats.validRecords}</p>
        ...
        <Card>
          <CardContent className="pt-4">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-critical-muted rounded-lg">
                <AlertTriangle className="h-5 w-5 text-critical" />
              </div>
              <div>
                <p className="text-2xl font-bold text-critical">{complianceStats.expired}</p>
                ...
                {insights.map((insight, index) => (
                  <div 
                    ...
                    className={`p-3 rounded-lg ${
                      insight.type === 'warning' ? 'bg-warning-muted border border-warning/20' :
                      insight.type === 'success' ? 'bg-success-muted border border-success/20' :
