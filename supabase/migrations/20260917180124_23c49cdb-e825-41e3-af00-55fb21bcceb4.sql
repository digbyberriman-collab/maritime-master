...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.hr_company_settings TO authenticated;
GRANT ALL ON public.hr_company_settings TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.crew_compensation TO authenticated;
GRANT ALL ON public.crew_compensation TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.crew_bank_details TO authenticated;
GRANT ALL ON public.crew_bank_details TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.gratuity_pools TO authenticated;
GRANT ALL ON public.gratuity_pools TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.gratuity_distributions TO authenticated;
GRANT ALL ON public.gratuity_distributions TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.pay_reviews TO authenticated;
GRANT ALL ON public.pay_reviews TO service_role;
